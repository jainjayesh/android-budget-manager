...
public class BudgetCycle {
   ...
   public BudgetCycle(Date start) {
	 ...
	 end = DateTimeUtils.toDate(result);
   }
   ...
   /**
    * Attempts to end the current budget cycle, if the end time has been
    * surpassed.
    * 
    * @return true, if the budget cycle was ended ended; false otherwise.
    */
   public boolean endBudgetCycle() {

	 if (end.getTime() < new Date().getTime()) {
	    // The end time has been surpassed
	    hasEnded = true;
	 }
	 return hasEnded;
   }

 ...
 * 
 */
public class BudgetPersisterTest extends ApplicationTestCase<Application> {

   private final BudgetCyclePersister persister = new BudgetCyclePersister();

   public BudgetPersisterTest() {
	 super(Application.class);
   }

   public BudgetPersisterTest(Class<Application> applicationClass) {
